...
REMEDIES = {
    ...
    "Potato___Late_blight": {
        ...
        "HI": {
            "disease_name": "Potato Late Blight (हिंदी)",
            "crop": "आलू",
            "cause": "Oomycete Phytophthora infestans. Spreads rapidly in cool, wet weather.",
            "symptoms": [
                "Water-soaked, dark green to brown lesions on leaves.",
        ...
        "TE": {
            "disease_name": "Potato Late Blight (తెలుగు)",
            "crop": "బంగాళాదుంప",
            "cause": "Oomycete Phytophthora infestans. Spreads rapidly in cool, wet weather.",
            "symptoms": [
                "Water-soaked, dark green to brown lesions on leaves.",
    ...
    "Strawberry___Leaf_scorch": {
        ...
        "HI": {
            "disease_name": "Strawberry Leaf Scorch (हिंदी)",
            "crop": "स्ट्रॉबेरी",
            "cause": "Fungus Diplocarpon earlianum. Spread by splashing rain in warm, humid weather.",
            "symptoms": [
                "Small, dark purple spots on upper leaf surface.",
        ...
        "TE": {
            "disease_name": "Strawberry Leaf Scorch (తెలుగు)",
            "crop": "స్ట్రాబెర్రీ",
            "cause": "Fungus Diplocarpon earlianum. Spread by splashing rain in warm, humid weather.",
            "symptoms": [
                "Small, dark purple spots on upper leaf surface.",
    ...
    "Tomato___Septoria_leaf_spot": {
        ...
        "HI": {
            "disease_name": "Tomato Septoria Leaf Spot (हिंदी)",
            "crop": "टमाटर",
            "cause": "Fungus Septoria lycopersici. Favors warm (20-25°C), wet weather with splashing rain.",
            "symptoms": [
                "Many small circular spots (2-3mm) with dark borders and gray centers.",
    ...
    "Tomato___Spider_mites Two-spotted_spider_mite": {
        "EN": {
            ...
            "crop": "Tomato",
            "cause": "Arachnid Tetranychus urticae. Hot, dry, dusty conditions favor outbreaks.",
            "symptoms": [
                "Fine stippling and yellowing on leaves.",
                "Silky webbing on leaf undersides.",
                "Severe infestations cause leaf bronzing and drop."
            ],
            "treatment_steps": [
                "Spray strong water jet to dislodge mites.",
                "Apply miticide at first sign of stippling.",
                "Release predatory mites (Phytoseiulus persimilis)."
            ],
            "organic_options": [
                "Neem oil at 5ml/L every 5 days.",
                "Insecticidal soap spray.",
                "Sulfur-based miticide."
            ],
            "chemical_options": [
                "Abamectin (Vertimec) at label rate.",
                "Spiromesifen (Oberon).",
                "Bifenazate miticide."
            ],
            "prevention": [
                ...
                "Monitor plants regularly with hand lens."
            ]
        },
        "HI": {
            "disease_name": "Tomato Spider Mites (Two-spotted) (हिंदी)",
            "crop": "टमाटर",
            "cause": "Arachnid Tetranychus urticae. Hot, dry, dusty conditions favor outbreaks.",
            "symptoms": [
                "Fine stippling and yellowing on leaves.",
        ...
        "TE": {
            "disease_name": "Tomato Spider Mites (Two-spotted) (తెలుగు)",
            "crop": "టమాటా",
            "cause": "Arachnid Tetranychus urticae. Hot, dry, dusty conditions favor outbreaks.",
            "symptoms": [
                "Fine stippling and yellowing on leaves.",
    ...
    "Tomato___Target_Spot": {
        "EN": {
            ...
            "crop": "Tomato",
            "cause": "Fungus Corynespora cassiicola. Warm, humid tropical/subtropical conditions.",
            "symptoms": [
            ...
            "chemical_options": [
                "Chlorothalonil at 7-day intervals.",
                "Azoxystrobin at label rate.",
                "Difenoconazole at recommended dose."
            ],
            "prevention": [
        ...
        "HI": {
            "disease_name": "Tomato Target Spot (हिंदी)",
            "crop": "टमाटर",
            "cause": "Fungus Corynespora cassiicola. Warm, humid tropical/subtropical conditions.",
            "symptoms": [
                "Small brown spots with concentric rings (target pattern).",
        ...
        "TE": {
            "disease_name": "Tomato Target Spot (తెలుగు)",
            "crop": "టమాటా",
            "cause": "Fungus Corynespora cassiicola. Warm, humid tropical/subtropical conditions.",
            "symptoms": [
                "Small brown spots with concentric rings (target pattern).",
    ...
    "Tomato___Tomato_Yellow_Leaf_Curl_Virus": {
        "EN": {
            ...
            "crop": "Tomato",
            "cause": "Begomovirus transmitted by whitefly (Bemisia tabaci). No plant-to-plant contact spread.",
            "symptoms": [
                "Upward curling of leaf margins.",
                "Yellowing and reduced leaf size.",
                "Severe stunting, flower drop, no fruit set."
            ],
            "treatment_steps": [
            ...
            "chemical_options": [
                "Imidacloprid soil drench at transplanting.",
                "Pyriproxyfen for whitefly control.",
                "Spiromesifen (Oberon) foliar spray."
            ],
            "prevention": [
                "Use TYLCV-resistant tomato varieties.",
                "Install fine-mesh insect-proof netting.",
                "Maintain whitefly-free transplant nursery."
            ]
        },
        "HI": {
            "disease_name": "Tomato Yellow Leaf Curl Virus (हिंदी)",
            "crop": "टमाटर",
            "cause": "Begomovirus transmitted by whitefly (Bemisia tabaci). No plant-to-plant contact spread.",
            "symptoms": [
                "Upward curling of leaf margins.",
        ...
        "TE": {
            "disease_name": "Tomato Yellow Leaf Curl Virus (తెలుగు)",
            "crop": "టమాటా",
            "cause": "Begomovirus transmitted by whitefly (Bemisia tabaci). No plant-to-plant contact spread.",
            "symptoms": [
                "Upward curling of leaf margins.",
    ...
    "Tomato___Tomato_mosaic_virus": {
        ...
        "HI": {
            "disease_name": "Tomato Mosaic Virus (हिंदी)",
            "crop": "टमाटर",
            "cause": "Tobamovirus. Extremely stable; spread by contact, contaminated tools, and seed.",
            "symptoms": [
                "Light and dark green mosaic mottling on leaves.",
